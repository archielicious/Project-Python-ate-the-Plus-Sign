#Program to find the Fibonacci Sequence starting from 0 to a given position and find the Fibonacci Number at any position upto this given position
def fibonacci_seq_from_zero():
